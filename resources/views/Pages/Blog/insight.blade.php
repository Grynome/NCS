@push('css-plugin')
    ...
    <link href="{{ asset('Assets') }}/CSS/article/insights.css" rel="stylesheet" />
@endpush
@extends('HeFo.header')
@section('content')
    <section class="video-article--head-bg mb-80 page-title text-center">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="heading heading-light mb-50 sticky-top">
                        <h3 class="heading__title text-font-archia mb-30">Insight
                        </h3>
    ...
    <div class="container mt-5">
        <article class="blog-card">
            ...
            <div class="canal-desc blog-card__info">
                ...
                <a href="{{ route('dt.canals') }}" class="btn__link btn__white btn__icon px-0">
